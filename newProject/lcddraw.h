...
/** Draw Triangle
 *
 *  \param isRight Determines wheter is Right or Left
 *  \param isHorizontal Determines wheter is Horizontal or Vertical
 *  \param colorBGR Color of rectangle in BGR
 */
void drawTriangle(u_char isRight, u_char isHorizontal, u_int colorBGR);
 ...
 *  \param colorBGR Color of rectangle in BGR
 */
void drawRectangle(u_char isRight, u_char isHorizontal, u_int colorBGR);
